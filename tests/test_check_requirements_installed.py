...
def test_lock_a_empreintes_lu(tmp_path):
    # Format de `uv pip compile --generate-hashes` : continuations, empreintes, commentaires « via ».
    ...
    assert chk.epingles(tmp_path / "r.txt") == {"anyio": "4.14.2", "cffi": "2.0.0"}
