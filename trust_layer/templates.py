...
{payment_evidence_html}
    ...
    <div class="cta-banner">
        <p class="cta-en" style="display:none">This proof was generated by <a href="https://arkforge.fr/en/pricing?utm_source=proof_view&utm_medium=proof_page&utm_content=cta_banner">ArkForge Trust Layer</a> \u2014 Certify your own AI transactions \u2192 <a class="cta-link" href="https://arkforge.fr/en/pricing?utm_source=proof_view&utm_medium=proof_page&utm_content=cta_banner">Get started free</a></p>
        <p class="cta-fr" style="display:none">Cette preuve a \u00e9t\u00e9 g\u00e9n\u00e9r\u00e9e par <a href="https://arkforge.fr/fr/pricing?utm_source=proof_view&utm_medium=proof_page&utm_content=cta_banner">ArkForge Trust Layer</a> \u2014 Certifiez vos transactions IA \u2192 <a class="cta-link" href="https://arkforge.fr/fr/pricing?utm_source=proof_view&utm_medium=proof_page&utm_content=cta_banner">Commencer gratuitement</a></p>
    </div>
    <script>
    (function(){{
        var fr=/^fr/i.test(navigator.language||"");
        var ep=document.querySelector(".cta-en"),fp=document.querySelector(".cta-fr");
        if(fr){{fp.style.display=""}}else{{ep.style.display=""}}
        var v=Math.random()<0.5?"a":"b";
        var links=document.querySelectorAll(".cta-link");
        if(v==="b"){{
            if(fr){{links[0].textContent="Obtenir ma cl\u00e9 API gratuite"}}
            else{{links[0].textContent="Get your free API key"}}
        }}
        for(var i=0;i<links.length;i++){{
            links[i].href=links[i].href.replace("cta_banner","cta_"+v);
        }}
    }})();
    </script>
